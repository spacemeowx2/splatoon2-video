...
const { resolvePath } = require('../node_modules/opencv4nodejs/lib/commons');
...
let cv = null
try {
  logDebug('require', 'require path is ' + '../node_modules/opencv4nodejs/build/Release/opencv4nodejs')
  cv = require('../node_modules/opencv4nodejs/build/Release/opencv4nodejs.node');
} catch (err) {
